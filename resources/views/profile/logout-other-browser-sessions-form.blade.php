<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Si es necesario, puede cerrar la sesión de todas las demás sesiones del navegador en todos sus dispositivos. Si cree que su cuenta ha sido comprometida, también debería actualizar su contraseña.
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                Salir de las sesiones de otros navegadores
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                Por favor, introduzca su contraseña para confirmar que desea cerrar la sesión de sus otras sesiones de navegación en todos sus dispositivos..

                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="Ingresa tu contraseña"
                                x-ref="password"
