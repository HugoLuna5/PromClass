    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <!-- Settings Dropdown -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex sm:items-center sm:ml-6">

                    <x-jet-nav-link class="text-white" href="/home" :active="request()->routeIs('home')">
                        Inicio
                    </x-jet-nav-link>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="/home" :active="request()->routeIs('homeAdmin')">
                    Panel de control
