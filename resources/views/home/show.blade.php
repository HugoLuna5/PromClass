                ...
                <div class="flex justify-center bg-grey-lighter w-1/3 m-5">
                    ...
                    <div id="mainCont" class="container">
                        ...
                        <div class="py-4  rounded-tl-lg rounded-tr-lg overflow-hidden bg-white shadow-lg px-10">
                            ...
                            <form class="w-full max-w-lg " method="POST" action="{{route('saveMatter')}}"
                        ...
                        <!--units-->
                        <div
                            class="mt-6 rounded-tl-lg rounded-tr-lg overflow-hidden bg-white shadow-lg align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                            <a class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
                                               href="{{route('showUnit', ['id' => $matter->id,'unit_id' => $unit->id])}}">Ver
                                                detalles</a>
                                        </td>
                                    </tr>
                            ...
                            @foreach($matter->activities as $activity)
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                        <div class="flex items-center">
                                            <div>
                                                <div data-title='{{$activity->name}}' data-placement="top"
                                                     class="text-sm leading-5 text-gray-800">{{ \Illuminate\Support\Str::limit($activity->name, 30, $end='...') }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                        <a class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none"
                                           href="{{route('showGroup', ['id' => $activity->id])}}">Ver detalles</a>
                                    </td>
                                </tr>
        ...
        $(document).ready(function () {
            ...
            $('.set-status').editable({
                ...
                source: [
                        @foreach($matter->units as $unit)
                    {
                        value: {{$unit->id}}, text: 'Unidad {{$unit->name}}'
                    },
                    @endforeach
